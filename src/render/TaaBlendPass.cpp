...
TaaBlendPass::TaaBlendPass(VulkanContext& ctx, VkFormat colorFormat, VkFormat depthFormat) : ctx_(ctx) {
    ...
    allocInfo.descriptorSetCount = CommandContext::kFramesInFlight;
    allocInfo.pSetLayouts = layouts.data();
    VK_CHECK(vkAllocateDescriptorSets(ctx_.device(), &allocInfo, descriptorSets_.data()));
    ...
    // Fullscreen triangle generated from gl_VertexIndex in tonemap.vert --
    // no vertex buffer, no vertex input state at all.
