...
void TonemapPass::updateSourceDescriptor(VkImageView hdrView, VkSampler hdrSampler) {
...
void TonemapPass::render(VkCommandBuffer cmd) {
    vkCmdBindPipeline(cmd, VK_PIPELINE_BIND_POINT_GRAPHICS, pipeline_);
    vkCmdBindDescriptorSets(cmd, VK_PIPELINE_BIND_POINT_GRAPHICS, layout_, 0, 1, &descriptorSet_, 0,
                             nullptr);
